 ...
 * https://github.com/riscv/riscv-opcodes (eb90130)
 */
...
#define MATCH_CORACOS 0x300b
#define MASK_CORACOS 0xfff0707f
#define MATCH_CORACOSI 0x302b
#define MASK_CORACOSI 0xff07f
#define MATCH_CORASIN 0x400b
#define MASK_CORASIN 0xfff0707f
#define MATCH_CORASINI 0x402b
#define MASK_CORASINI 0xff07f
#define MATCH_CORATAN 0x500b
#define MASK_CORATAN 0xfff0707f
#define MATCH_CORATANI 0x502b
#define MASK_CORATANI 0xff07f
#define MATCH_CORCOS 0xb
#define MASK_CORCOS 0xfff0707f
#define MATCH_CORCOSI 0x2b
#define MASK_CORCOSI 0xff07f
#define MATCH_CORDIV 0x200100b
#define MASK_CORDIV 0xfe00707f
#define MATCH_CORDIVI 0x702b
#define MASK_CORDIVI 0x707f
#define MATCH_COREXP 0x200200b
#define MASK_COREXP 0xfff0707f
#define MATCH_CORLN 0x200300b
#define MASK_CORLN 0xfff0707f
#define MATCH_CORMUL 0x200000b
#define MASK_CORMUL 0xfe00707f
#define MATCH_CORMULI 0x602b
#define MASK_CORMULI 0x707f
#define MATCH_CORSIN 0x100b
#define MASK_CORSIN 0xfff0707f
#define MATCH_CORSINI 0x102b
#define MASK_CORSINI 0xff07f
#define MATCH_CORSQRT 0x200400b
#define MASK_CORSQRT 0xfff0707f
#define MATCH_CORTAN 0x200b
#define MASK_CORTAN 0xfff0707f
#define MATCH_CORTANI 0x202b
#define MASK_CORTANI 0xff07f
...
DECLARE_INSN(coracos, MATCH_CORACOS, MASK_CORACOS)
DECLARE_INSN(coracosi, MATCH_CORACOSI, MASK_CORACOSI)
DECLARE_INSN(corasin, MATCH_CORASIN, MASK_CORASIN)
DECLARE_INSN(corasini, MATCH_CORASINI, MASK_CORASINI)
DECLARE_INSN(coratan, MATCH_CORATAN, MASK_CORATAN)
DECLARE_INSN(coratani, MATCH_CORATANI, MASK_CORATANI)
DECLARE_INSN(corcos, MATCH_CORCOS, MASK_CORCOS)
DECLARE_INSN(corcosi, MATCH_CORCOSI, MASK_CORCOSI)
DECLARE_INSN(cordiv, MATCH_CORDIV, MASK_CORDIV)
DECLARE_INSN(cordivi, MATCH_CORDIVI, MASK_CORDIVI)
DECLARE_INSN(corexp, MATCH_COREXP, MASK_COREXP)
DECLARE_INSN(corln, MATCH_CORLN, MASK_CORLN)
DECLARE_INSN(cormul, MATCH_CORMUL, MASK_CORMUL)
DECLARE_INSN(cormuli, MATCH_CORMULI, MASK_CORMULI)
DECLARE_INSN(corsin, MATCH_CORSIN, MASK_CORSIN)
DECLARE_INSN(corsini, MATCH_CORSINI, MASK_CORSINI)
DECLARE_INSN(corsqrt, MATCH_CORSQRT, MASK_CORSQRT)
DECLARE_INSN(cortan, MATCH_CORTAN, MASK_CORTAN)
DECLARE_INSN(cortani, MATCH_CORTANI, MASK_CORTANI)
